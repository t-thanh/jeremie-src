...
int main(int argc, char** argv)
{
    ...
    ros::Publisher topic_pub = nh.advertise<geometry_msgs::PoseStamped>("uav/gimbal/Target_Relative_Pose", 10);
    ...
    image_transport::Subscriber sub = it.subscribe("/uav1/servo_camera/image_raw", 1, boost::bind(imageCallback, _1, view_image, detectorParams, dictionary, cameraMatrix, distCoeffs, topic_pub));
